...
<pre><strong>Input: </strong>n = <span id="example-input-2-1">89</span>
...
<pre><strong>Input: </strong>n = <span id="example-input-3-1">11</span>
...
<pre><strong>Input: </strong>n = <span id="example-input-4-1">25</span>
